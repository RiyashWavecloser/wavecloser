...
const STAFF_ACCOUNTS = [
  ...
  { email: 'mildred@waveclosers.com', name: 'Mildred', role: 'cx'       },
  ...
  // Open Item #12: "Confirm Aureliab's exact email address (Recruiter/Franchise Sales)"
  { email: 'aureliab@waveclosers.com', name: 'Aureliab', role: 'recruiter' },
];
...
async function seed() {
  ...
  console.log('\n[seed-staff] Seeding 9 cold-calling agents (Janina is agent, NOT recruiter)...');
