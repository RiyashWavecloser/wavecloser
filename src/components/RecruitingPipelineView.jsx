/**
 * src/components/RecruitingPipelineView.jsx
 * Reusable Recruiting / Salesperson Onboarding pipeline view.
 * 
 * Used by:
...
export default function RecruitingPipelineView({ currentUser }) {
  const recruiterName = currentUser?.name || 'Agent';
