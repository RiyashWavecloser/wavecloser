 ...
 *   - Full 6-step onboarding checklist with step owners and routing note
 */
export default function UserDrawer({ user, onClose, onUpdateUser }) {
  ...
  function stepForward() {
    if (user.stage >= 6 || !onUpdateUser) return;
        ...
        <div style={{ padding:24 }}>
          ...
          <Section label="Onboarding stage">
            ...
            <div style={styles.stageButtons}>
              ...
              <button onClick={stepForward} disabled={user.stage >= 6} style={{ ...styles.stageBtn, ...styles.stageBtnPrimary }}>Step forward →</button>
            </div>
          </Section>
          ...
          <Section label="6-step onboarding checklist (click step to set)">
