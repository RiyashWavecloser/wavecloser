...
import { AUTOMATION_TASKS } from '../data/constants.js';
...
export default function AutomationPanel({ users: _users }) {
  ...
  return (
    <div style={S.wrap}>
      <PageHeader title="AI Automation (Orca)" subtitle="Claude running background tasks — scope §8" />
      ...
      <div className="wc-two-col" style={S.twoCol}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
          ...
          <Card>
            ...
            />
            {log.length === 0
              ? <EmptyState icon="✦" title="No automation activity yet" message="Activity will appear here as the system runs automations." />
